                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav m-auto">
                        ...
                        foreach ($data['categories'] as $category) {
                            echo '<a href="/client/category?id=' . $category['id'] . '" class="nav-item nav-link" data-id="' . $category['id'] . '">' . $category['name'] . '</a>';
                        }                        
                        ?>
                ...
                <div class="das">
                    ...
                    if (isset($_SESSION['user'])) {
                        if ($_SESSION['roles'] == 1) {
                            ...
                            echo '<button class="btn btn-outline-light ml-auto dropdown-toggle tro" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
                            echo '';
                            echo '</button>';
                            ...
                            echo '<p class="name-user">' . $_SESSION['Name'] . '</p>';
                            echo '<div class="dropdown">';
                            echo '<button class="btn btn-outline-light ml-auto dropdown-toggle" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">';
                            echo '';
                            echo '</button>';
                            echo '<div class="dropdown-menu" aria-labelledby="userDropdown">';
