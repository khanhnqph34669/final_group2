                        ...
                        <?php foreach ($posts as $post) : ?>
                            <?php if ($post['author_Id'] == $_SESSION['id']) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <button onclick="confirmDelete(<?= $post['Id'] ?>)" class="btn btn-danger">Xóa</button>
                                        <a href="/author/post/update?id=<?= $post['Id'] ?>"><button type="button" class="btn btn-primary">Sửa</button></a>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        <?php endforeach; ?>
